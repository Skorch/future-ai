/**
 * Unit tests for DiscoveryAgentBuilder
...
describe('DiscoveryAgentBuilder', () => {
  // Mock data
  ...
  const builder = new DiscoveryAgentBuilder();
  ...
  describe('generate', () => {
    ...
    it('should include discovery mode identifier in output', () => {
      const result = builder.generate(mockDomain, null, null);

      // Verify it contains discovery mode prompt
    ...
    it('should not include build mode content', () => {
      const result = builder.generate(mockDomain, null, null);

      // Verify it doesn't contain build mode markers
